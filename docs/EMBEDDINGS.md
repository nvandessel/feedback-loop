...
bash "$(go env GOMODCACHE)/github.com/lancedb/lancedb-go@${LANCE_VERSION}/scripts/download-artifacts.sh" "${LANCE_VERSION}" || { echo "Failed to download LanceDB native libraries"; exit 1; }
